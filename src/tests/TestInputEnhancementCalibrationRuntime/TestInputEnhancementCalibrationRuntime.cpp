...
void TestInputEnhancementCalibrationRuntime::immutablePackageAuthorizationFailsClosed() {
	...
	// Balanced maps the public 0-100 control into its qualified 20-55
	// interval. A one-step public change can therefore quantize to the same
	// recipe; use a value that is guaranteed to exercise exact authorization.
