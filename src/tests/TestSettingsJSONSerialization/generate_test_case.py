...
def generateTestBody(settingsFields, settingsClassName, excludeFields = []):
    ...
    contents += "\t\tsettings.qbaModernAuxiliaryWindowGeometries = QByteArrayLiteral(\"qml-aux-window-states\");\n"
    contents += "\n"
    ...
    contents += "\t\tQCOMPARE(loaded.qbaModernAuxiliaryWindowGeometries, settings.qbaModernAuxiliaryWindowGeometries);\n"
